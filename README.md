...
```bash
hallumark --version
hallumark scan demos/                          # run against bundled demo
hallumark scan demos/ --format sarif --out r.sarif --fail-on high
hallumark mcp                                   # start as MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
- `demos/01-legal-rag/` — see [`SCENARIO.md`](demos/01-legal-rag/SCENARIO.md)
- `demos/02-customer-support-rag/` — see [`SCENARIO.md`](demos/02-customer-support-rag/SCENARIO.md)
- `demos/03-internal-policy-bot/` — see [`SCENARIO.md`](demos/03-internal-policy-bot/SCENARIO.md)
