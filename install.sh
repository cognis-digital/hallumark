#!/usr/bin/env sh
# Universal installer for hallumark. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/hallumark.git"
echo "Installing hallumark ..."
